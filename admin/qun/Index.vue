<template>
	<div class="page">
		<div class="header">
			<div class="top">
				<div class="right">
					<u-search background="#fff" v-model="list.query.words" placeholder="搜索群名称" animation="false" />
				</div>
			</div>
		</div>
		<div class="list">
			<list class="van-list">
				<div v-for="(item, key) in list.data" class="item" :key="key">
					<div class="invite-info">
						ID:{{item.id}}
						<div style="float: right;" v-if="item.user">(UID:{{item.user.nickname}}){{item.user.nickname}}</div>
